...
function showLinksInfo() {
    ...
    const lastLink = links[linkCount - 1].href;
    alert(`Cantidad de enlaces: ${linkCount}\nPrimer enlace: ${firstLink}\nÚltimo enlace: ${lastLink}`);
}
...
// Seleccionar la sección con un id de contenedor sin usar querySelector
const container1 = document.getElementById('container');

// Seleccionar la sección con un id de contenedor usando querySelector
const container2 = document.querySelector('#container');

// Seleccionar todos los elementos de la lista con una clase de "second"
const secondItems = document.getElementsByClassName('second');

// Seleccionar un elemento de la lista con una clase de third, solo el elemento de la lista dentro de la etiqueta ol
const thirdItemInOl = document.querySelector('ol .third');

// Dar el texto "¡Hola!" a la sección con un id de contenedor
container1.textContent = '¡Hola!';

// Agregar la clase principal al div con una clase de pie de página
const footer = document.querySelector('.footer');
footer.classList.add('principal');

// Eliminar la clase principal del div con una clase de pie de página
...
// Desafíate a ti mismo: Repite sobre todos los li dentro de la etiqueta ol y dales un color de fondo "verde"
const olItems = document.querySelectorAll('ol li');
olItems.forEach(item => {
    item.style.backgroundColor = 'green';
});

// Eliminar el div con una clase de pie de página
footer.remove();
